    ...
    <div class="stat-card">
        <div style="display: flex; align-items: center; gap: 1.25rem; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                ...
                <div class="stat-value"><?= $totalTour ?? 0 ?></div>
    ...
    <div class="stat-card">
        <div style="display: flex; align-items: center; gap: 1.25rem; margin-bottom: 1rem;">
            ...
            <div style="flex: 1;">
                ...
                <div class="stat-value"><?= $totalHDV ?? 0 ?></div>
                <div class="stat-trend up">
                    <i class="bi bi-arrow-up"></i>
    ...
    <div>
        <div class="activity-item">
            ...
            <div class="activity-content">
                <div class="activity-title">Booking mới #1234</div>
        ...
        <div class="activity-item">
            ...
            <div class="activity-content">
                <div class="activity-title">Tour mới được tạo</div>
        ...
        <div class="activity-item">
            ...
            <div class="activity-content">
                <div class="activity-title">HDV mới được thêm</div>
